...
function addToArray(list) {
    ...
    let date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(formattedDate, 'MMMM dd yyyy');
    let taskPriority = document.querySelector('.priority').checked;
    let newTask = new _project_js__WEBPACK_IMPORTED_MODULE_0__.taskObject(taskName.value,taskDescription.value,date,taskPriority);
    list.push(newTask);
}
