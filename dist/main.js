...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./fonts/MinecraftTen-VGORe.ttf */ "./src/fonts/MinecraftTen-VGORe.ttf"), __webpack_require__.b);
...
.header > .title {
    font-size:40px;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,wBAAwB;IACxB,4CAAwC;AAC5C;;AAEA;IACI,YAAY;IACZ,8BAA8B;IAC9B,2BAA2B;IAC3B,YAAY;AAChB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,QAAQ;IACR,iBAAiB;AACrB;;AAEA;IACI,YAAY;IACZ,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,YAAY;IACZ,sBAAsB;IACtB,2BAA2B;IAC3B,OAAO;AACX;;AAEA;;IAEI,eAAe;IACf,eAAe;AACnB;;AAEA;;IAEI,YAAY;IACZ,wCAAwC;IACxC,OAAO;AACX;;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,WAAW;IACX,oCAAoC;AACxC;;AAEA;IACI,YAAY;IACZ,sBAAsB;IACtB,qBAAqB;IACrB,WAAW;IACX,OAAO;AACX;;AAEA;IACI,YAAY;IACZ,yDAAyD;IACzD,oBAAoB;IACpB,QAAQ;IACR,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,sBAAsB;IACtB,QAAQ;IACR,WAAW;IACX,kBAAkB;IAClB,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;AAC1B;;AAEA,WAAW;;AAEX;IACI,WAAW;IACX,gCAAgC;AACpC;;AAEA;IACI,mCAAmC;AACvC;;AAEA;IACI,mCAAmC;AACvC;;AAEA;IACI,mCAAmC;IACnC,WAAW;IACX,kBAAkB;IAClB,4CAA4C;AAChD;;AAEA;IACI,mCAAmC;AACvC;;AAEA;;IAEI,mCAAmC;AACvC;;AAEA;IACI,uCAAuC;IACvC,WAAW;IACX,mBAAmB;IACnB,WAAW;IACX,YAAY;IACZ,sBAAsB;AAC1B;;AAEA;IACI,wBAAwB;IACxB,sBAAsB;AAC1B;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,8BAA8B;AAClC;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,kBAAkB;IAClB,WAAW;AACf;;AAEA;IACI,cAAc;AAClB","sourcesContent":["@font-face {\n    font-family: 'Minecraft';\n    src: url(./fonts/MinecraftTen-VGORe.ttf);\n}\n\n.container {\n    display:grid;\n    grid-template-columns: 1fr 5fr;\n    grid-template-rows: 1fr 8fr;\n    height:100vh;\n}\n\n.container > .header {\n    grid-column: 1/-1;\n}\n\n.container > div {\n    border: 1px solid black;\n}\n\nbody {\n    margin:0;\n    position:relative;\n}\n\n.container > .header {\n    display:flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.sidebar > div {\n    border: 1px solid black;\n}\n\n.sidebar {\n    display:flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    gap:1em;\n}\n\n.home > #header,\n.projects > .header {\n    font-weight:700;\n    font-size: 24px;\n}\n\n.home,\n.projects {\n    display:grid;\n    grid-template-rows: repeat(auto-fit,1fr);\n    gap:1em;\n}\n\n.content > .header {\n    text-align: center;\n    margin:1em;\n    padding:1em;\n    background-color: rgb(167, 165, 165);\n}\n\n.content {\n    display:flex;\n    flex-direction: column;\n    align-content: center;\n    padding:1em;\n    gap:1em;\n}\n\n.cards {\n    display:grid;\n    grid-template-columns: repeat(auto-fit,minmax(300px,1fr));\n    grid-auto-rows: auto;\n    gap:15px;\n    overflow:auto;\n}\n\n.card {\n    display:flex;\n    flex-direction: column;\n    gap:10px;\n    padding:1em;\n    text-align: center;\n    border:1px solid black;\n}\n\n.home > div:not(:first-child):hover {\n    background-color: grey;\n}\n\n.projectItem:hover {\n    background-color: grey;\n}\n\n/* colors */\n\nhtml {\n    color:white;\n    font-family:Minecraft,sans-serif;\n}\n\n.container > .header {\n    background-color:rgba(29,29,29,255);\n}\n\n.content {\n    background-color:rgba(18,18,18,255);\n}\n\n.card {\n    background-color:rgba(29,29,29,255);\n    border:none;\n    border-radius:10px;\n    border-left:10px solid rgba(187,134,252,255);\n}\n\n.sidebar {\n    background-color:rgba(18,18,18,255);\n}\n\n.home,\n.projects {\n    background-color:rgba(29,29,29,255);\n}\n\nbutton {\n    background-color: rgba(187,134,252,255);\n    border:none;\n    border-radius: 10px;\n    color:white;\n    padding:10px;\n    font-family: Minecraft;\n}\n\n.content > .header {\n    background-color:#404040;\n    font-family: Minecraft;\n}\n\n#form {\n    font-family:Minecraft;\n}\n\n.dim {\n    border-left:10px solid #D0F0C0;\n}\n\n.choice:hover {\n    background-color: grey;\n}\n\n.sidebar > div {\n    text-align: center;\n    padding:1em;\n}\n\n.header > .title {\n    font-size:40px;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   moveIntoProject: () => (/* binding */ moveIntoProject),
...
function addToArray() {
    ...
    let newTask = new _project_js__WEBPACK_IMPORTED_MODULE_0__.taskObject(taskName.value,taskDescription.value,originalDate,taskPriority,taskStatus);
    // screen
    allTasks.push(newTask);
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date)) {todayTasks.push(newTask)}
    if (((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date,today) >= 0) && ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date,today) < 7)) {nextWeekTasks.push(newTask)}
...
function evaluateTask(specificlist) {
    if (!content.contains(document.querySelector('#form'))) {
        addForm(referenceTask,(0,_forms_js__WEBPACK_IMPORTED_MODULE_1__.createTaskForm)(false));
...
function displayActive(array) {
    for (const item of array) {
            ...
            let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(newDate, 'MMMM dd yyyy');
...
function moveIntoProject(e) {
    if (e.target && e.target.classList.contains('move')) {
        ...
        if (e.target.contains(document.getElementById('form'))) {
            ...
            e.target.appendChild((0,_forms_js__WEBPACK_IMPORTED_MODULE_1__.moveToProjectForm)(projectList));
...
function editItem(e) {
    if (e.target && e.target.classList.contains('edit')) {
        ...
        container.appendChild((0,_forms_js__WEBPACK_IMPORTED_MODULE_1__.createTaskForm)(true));
...
function updateItem(task) {
    ...
    let today = new Date();
    let taskPriority = document.querySelector('.priority').checked;
    let newTask = new _project_js__WEBPACK_IMPORTED_MODULE_0__.taskObject(taskName.value,taskDescription.value,originalDate,taskPriority);
    ...
    if (nextWeekTasks.includes(task)) {
        if (((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date,today) >= 0) && ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date,today) < 7)) {
...
/* harmony export */   moveToProjectForm: () => (/* binding */ moveToProjectForm)
/* harmony export */ });
...
function createTaskForm(boolean) {
    let form = document.createElement('div');
    form.setAttribute('id','form');
...
function moveToProjectForm(array) {
...
const taskObject = function(name,description,date,priority,status) {
    this.name = name;
